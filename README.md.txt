...
This project implements a Resume Screening system using Natural Language Processing and Machine Learning techniques.

It classifies resumes into job categories using:
...
## Results
Random Forest and Decision Tree achieved 99% accuracy on the dataset.